...
colombia <- redatam.open("COL/1.Ingreso/data/cpv2018col-cde.dicX")
...
saveRDS(CONTEOS, file = "COL/1.Ingreso/Data/CONTEOS.rds")
rm(list = "$table1")
#CONTEOS <-  readRDS(file = "COL/1.Ingreso/Data/CONTEOS.rds")
...
saveRDS(censo_mrp, "COL/1.Ingreso/Data/censo_mrp.rds")
...
saveRDS(tasa_desocupacion, "COL/1.Ingreso/Data/tasa_desocupacion.rds")
saveRDS(tasa_desocupacion, "COL/2.Pobreza/Data/tasa_desocupacion.rds")
saveRDS(tasa_desocupacion, "COL/3.PobrezaExtrema/Data/tasa_desocupacion.rds")
...
upms <- sas7bdat::read.sas7bdat("COL/1.Ingreso/Data/upm_dpto_2018.sas7bdat")
...
## Guardar encuesta
saveRDS(encuesta2, "COL/1.Ingreso/Data/encuestaCOL18N1.rds")
