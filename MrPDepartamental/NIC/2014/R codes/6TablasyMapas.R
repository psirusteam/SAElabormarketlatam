...
ShapeSAE <- read_sf("MrPDepartamental/NIC/2014/ShapeDeptoNIC/NIC_adm1.shp")
...
ShapeSAE %<>% mutate(depto = case_when(depto == "03" ~ "50",
                                       depto == "04" ~ "75",
                                       depto == "08" ~ "70",
                                       depto == "11" ~ "35",
                                       depto == "12" ~ "20",
...
openxlsx::write.xlsx(dat_df, 
                     file = "MrPDepartamental/NIC/2014/Output/tablas.xlsx", 
                     overwrite = TRUE)
openxlsx::openXL("MrPDepartamental/NIC/2014/Output/tablas.xlsx")
