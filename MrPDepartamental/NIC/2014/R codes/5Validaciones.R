...
if(!dir.exists("MrPDepartamental/NIC/2014/Output/Tasa desocupados/")){
dir.create("MrPDepartamental/NIC/2014/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/NIC/2014/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/NIC/2014/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/NIC/2014/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/NIC/2014/Output/Tasa participacion/")
}

outParticipacion <- "MrPDepartamental/NIC/2014/Output/Tasa participacion/"
outOcupado <- "MrPDepartamental/NIC/2014/Output/Tasa Ocupados/"
outDesocupado <- "MrPDepartamental/NIC/2014/Output/Tasa desocupados/"
# Librerías
...
# Loading data ------------------------------------------------------------
encuesta_mrp <- readRDS("MrPDepartamental/NIC/2014/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
poststrat_df <- readRDS("MrPDepartamental/NIC/2014/Data/poststrat_df.RDS")
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/NIC/2014/Output/plot_",
