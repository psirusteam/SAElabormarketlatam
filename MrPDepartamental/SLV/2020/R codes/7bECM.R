...
poststrat_df <- readRDS("SLV/2020/1.Ingreso/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
tasa_desocupados <- readRDS("SLV/2020/1.Ingreso/Data/tasa_desocupacion.rds")
fit <- readRDS("SLV/2020/1.Ingreso/Data/fit_bayes.rds")
...
openxlsx::write.xlsx(tablas, file = "SLV/2020/1.Ingreso/Output/tablas_ECM.xlsx", 
                     overwrite = TRUE)
