...
if(!dir.exists("MrPDepartamental/SLV/2020/Output/Tasa desocupados/")){
dir.create("MrPDepartamental/SLV/2020/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/SLV/2020/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/SLV/2020/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/SLV/2020/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/SLV/2020/Output/Tasa participacion/")
}

outParticipacion <- "MrPDepartamental/SLV/2020/Output/Tasa participacion/"
outOcupado <- "MrPDepartamental/SLV/2020/Output/Tasa Ocupados/"
outDesocupado <- "MrPDepartamental/SLV/2020/Output/Tasa desocupados/"
# Librerías
...
# Loading data ------------------------------------------------------------
encuesta_mrp <- readRDS("MrPDepartamental/SLV/2020/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
poststrat_df <- readRDS("MrPDepartamental/SLV/2020/Data/poststrat_df.RDS")
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/SLV/2020/Output/plot_",
