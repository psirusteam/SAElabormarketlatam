...
####################################################
encuesta <- readRDS("MrPDepartamental/SLV/2020/1.Ingreso/Data/encuestaSLV20n.rds")
censo_mrp <- readRDS( "MrPDepartamental/SLV/2020/1.Ingreso/Data/censo_mrp.rds")
...
encuesta_mrp <- encuesta %>% 
  ...
  anoest = case_when(
    edad < 7 | is.na(anoest)   ~ "98"  , #No aplica
    anoest == 99 ~ "99", #NS/NR
...
saveRDS(encuesta_mrp, file = "MrPDepartamental/SLV/2020/1.Ingreso/Data/encuesta_mrp.rds")
...
jpeg(filename = "MrPDepartamental/SLV/2020/1.Ingreso/Output/plot_actualizacion_censo1.jpeg",
...
jpeg(filename = "MrPDepartamental/SLV/2020/1.Ingreso/Output/plot_actualizacion_censo2.jpeg",
     width = 2000, height = 2000)
par(mfrow = c(2,2))
hist(censo_mrp$n)
boxplot(censo_mrp$n)
