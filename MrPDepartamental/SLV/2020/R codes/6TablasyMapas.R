...
## leer shape del pais
ShapeSAE <- read_sf("MrPDepartamental/SLV/2020/ShapeDeptoSLV/SLV_adm1.shp")
...
ShapeSAE %<>% mutate(depto = case_when( depto == "12" ~ "02",
                                        depto == "13" ~ "03",
                                        depto == "03" ~ "04",
                                        depto == "10" ~ "06",
                                        depto == "04" ~ "07",
...
openxlsx::write.xlsx(dat_df, 
                     file = "MrPDepartamental/SLV/2020/Output/tablas.xlsx", 
                     overwrite = TRUE)
openxlsx::openXL("MrPDepartamental/SLV/2020/Output/tablas.xlsx")
