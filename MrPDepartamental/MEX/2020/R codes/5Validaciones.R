...
if(!dir.exists("MrPDepartamental/MEX/2020/Output/Tasa desocupados/")){
  dir.create("MrPDepartamental/MEX/2020/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/MEX/2020/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/MEX/2020/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/MEX/2020/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/MEX/2020/Output/Tasa participacion/")
}

outParticipacion <- "MrPDepartamental/MEX/2020/Output/Tasa participacion/"
outOcupado <- "MrPDepartamental/MEX/2020/Output/Tasa Ocupados/"
outDesocupado <- "MrPDepartamental/MEX/2020/Output/Tasa desocupados/"
# Librerías
...
# Loading data ------------------------------------------------------------
encuesta_mrp <- readRDS("MrPDepartamental/MEX/2020/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
poststrat_df <- readRDS("MrPDepartamental/MEX/2020/Data/poststrat_df.RDS")
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/MEX/2020/Output/plot_",
