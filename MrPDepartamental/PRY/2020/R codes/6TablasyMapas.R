...
## Leer Shape del pais
ShapeSAE <- read_sf("MrPDepartamental/PRY/2020/ShapeDeptoPRY/PRY_adm1.shp")
...
openxlsx::write.xlsx(dat_df, 
                     file = "MrPDepartamental/PRY/2020/Output/tablas.xlsx", 
                     overwrite = TRUE)
openxlsx::openXL("MrPDepartamental/PRY/2020/Output/tablas.xlsx")
