...
poststrat_df <- readRDS("PRY/2020/1.Ingreso/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
tasa_desocupados <- readRDS("PRY/2020/1.Ingreso/Data/tasa_desocupacion.rds")
fit <- readRDS("PRY/2020/1.Ingreso/Data/fit_bayes.rds")
...
openxlsx::write.xlsx(tablas, file = "PRY/2020/1.Ingreso/Output/tablas_ECM.xlsx", 
                     overwrite = TRUE)
