...
if(!dir.exists("MrPDepartamental/PRY/2020/Output/Tasa desocupados/")){
  dir.create("MrPDepartamental/PRY/2020/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/PRY/2020/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/PRY/2020/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/PRY/2020/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/PRY/2020/Output/Tasa participacion/")
}

outParticipacion <- "MrPDepartamental/PRY/2020/Output/Tasa participacion/"
outOcupado <- "MrPDepartamental/PRY/2020/Output/Tasa Ocupados/"
outDesocupado <- "MrPDepartamental/PRY/2020/Output/Tasa desocupados/"
# Librerías
...
# Loading data ------------------------------------------------------------
encuesta_mrp <- readRDS("MrPDepartamental/PRY/2020/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
poststrat_df <- readRDS("MrPDepartamental/PRY/2020/Data/poststrat_df.RDS")
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/PRY/2020/Output/plot_",
