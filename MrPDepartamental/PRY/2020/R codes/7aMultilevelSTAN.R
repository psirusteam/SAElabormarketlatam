...
encuesta_mrp <- readRDS("PRY/2020/1.Ingreso/Data/encuesta_mrp.rds")
tasa_desocupados <- readRDS("PRY/2020/1.Ingreso/Data/tasa_desocupacion.rds")
...
saveRDS(fit, file = "PRY/2020/1.Ingreso/Data/fit_bayes.rds")
# Assessment of the model -------------------------------------------------
#shinystan::launch_shinystan(fit)
############################################################
## Comparando los medelos Freq y Bayes
############################################################
fit_freq <- readRDS("PRY/2020/1.Ingreso/Data/fit_mrp_logshift.rds")[[1]]
fit_Bayes <- readRDS("PRY/2020/1.Ingreso/Data/fit_bayes.rds")
