...
####################################################
encuesta <- readRDS("MrPDepartamental/PRY/2020/1.Desocupacion/Data/encuestaPRY20n.rds" )
censo_mrp <- readRDS( "MrPDepartamental/PRY/2020/1.Desocupacion/Data/censo_mrp.rds")
##############################
...
saveRDS(encuesta_mrp, file = "MrPDepartamental/PRY/2020/1.Desocupacion/Data/encuesta_mrp.rds")
...
jpeg(filename = "MrPDepartamental/PRY/2020/1.Desocupacion/Output/plot_actualizacion_censo1.jpeg",
...
jpeg(filename = "MrPDepartamental/PRY/2020/1.Desocupacion/Output/plot_actualizacion_censo2.jpeg",
     width = 2000, height = 2000)
par(mfrow = c(2,2))
hist(censo_mrp$n)
boxplot(censo_mrp$n)
...
saveRDS(censo_mrp, "MrPDepartamental/PRY/2020/1.Desocupacion/Data/censo_mrp.rds")
