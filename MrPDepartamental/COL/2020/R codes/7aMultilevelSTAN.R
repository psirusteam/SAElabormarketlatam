...
tasa_desocupados <- readRDS("COL/2020/1.Ingreso/Data/tasa_desocupacion.rds")
...
saveRDS(fit, file = "COL/2020/1.Ingreso/Data/fit_bayes.rds")
# Assessment of the model -------------------------------------------------
#shinystan::launch_shinystan(fit)
############################################################
## Comparando los medelos Freq y Bayes
############################################################
fit_freq <- readRDS("COL/2020/1.Ingreso/Data/fit_mrp_logshift.rds")[[1]]
fit_Bayes <- readRDS("COL/2020/1.Ingreso/Data/fit_bayes.rds")
...
# 
#  colMeans(y_pred_B)
#  g <- ggplot(data.frame(datos = c(y_sam, y_pred, colMeans(y_pred_B)),
#                    repe = gl(3, length(y_sam),
#                              labels = c("muestra", "Freq", "Bayes"))),
#         aes(x = datos, fill = repe, alpha = 0.1)) +
#    geom_density() + xlim(0,2000000) 
# ggsave(plot = g, filename = "COL/2020/1.Ingreso/Output/Freq_Vs_Bayes3.png",
#        scale = 4)
