...
if(!dir.exists("MrPDepartamental/COL/2020/Output/Tasa desocupados/")){
  dir.create("MrPDepartamental/COL/2020/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/COL/2020/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/COL/2020/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/COL/2020/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/COL/2020/Output/Tasa participacion/")
}
...
# Loading data ------------------------------------------------------------
encuesta_mrp <- readRDS("MrPDepartamental/COL/2020/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
...
ggsave(plot = plot_uni, 
       filename = paste0(outParticipacion,"plot_uni.jpeg"),
       scale = 4)
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/COL/2020/Output/plot_",
