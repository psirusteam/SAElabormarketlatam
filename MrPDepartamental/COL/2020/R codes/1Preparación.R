...
####################################################
encuesta <- readRDS("MrPDepartamental/COL/2020/1.Desocupacion/Data/encuestaCOL20N1.rds")
censo_mrp <- readRDS( "MrPDepartamental/COL/2020/1.Desocupacion/Data/censo_mrp.rds")
...
# labelled::generate_dictionary(encuesta %>% select(sexo))
 ...
 table(encuesta$edad , encuesta$condact3,encuesta$areageo2, useNA = "always")
...
saveRDS(encuesta_mrp, file = "MrPDepartamental/COL/2020/1.Desocupacion/Data/encuesta_mrp.rds")
...
jpeg(filename = "MrPDepartamental/COL/2020/1.Desocupacion/Output/plot_actualizacion_censo1.jpeg",
...
jpeg(filename = "MrPDepartamental/COL/2020/1.Desocupacion/Output/plot_actualizacion_censo2.jpeg",
     width = 2000, height = 2000)
par(mfrow = c(2,2))
hist(censo_mrp$n)
boxplot(censo_mrp$n)
...
saveRDS(censo_mrp, "MrPDepartamental/COL/2020/1.Desocupacion/Data/censo_mrp.rds")
