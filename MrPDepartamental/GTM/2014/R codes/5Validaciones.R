...
if(!dir.exists("MrPDepartamental/GTM/2014/Output/Tasa desocupados/")){
dir.create("MrPDepartamental/GTM/2014/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/GTM/2014/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/GTM/2014/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/GTM/2014/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/GTM/2014/Output/Tasa participacion/")
}
...
# Loading data ------------------------------------------------------------
encuesta_mrp <- readRDS("MrPDepartamental/GTM/2014/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/GTM/2014/Output/plot_",
