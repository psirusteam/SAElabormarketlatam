...
encuesta_mrp <- readRDS("GTM/1.Ingreso/Data/encuesta_mrp.rds")
poststrat_df <- readRDS("GTM/1.Ingreso/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
tasa_desocupados <- readRDS("GTM/1.Ingreso/Data/tasa_desocupacion.rds")
fit <- readRDS("GTM/1.Ingreso/Data/fit_bayes.rds")
...
openxlsx::write.xlsx(tablas, file = "GTM/1.Ingreso/Output/tablas_ECM.xlsx", 
                     overwrite = TRUE)
