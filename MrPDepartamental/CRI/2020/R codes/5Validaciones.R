...
if(!dir.exists("MrPDepartamental/CRI/2020/Output/Tasa desocupados/")){
  dir.create("MrPDepartamental/CRI/2020/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/CRI/2020/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/CRI/2020/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/CRI/2020/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/CRI/2020/Output/Tasa participacion/")
}

outParticipacion <- "MrPDepartamental/CRI/2020/Output/Tasa participacion/"
outOcupado <- "MrPDepartamental/CRI/2020/Output/Tasa Ocupados/"
outDesocupado <- "MrPDepartamental/CRI/2020/Output/Tasa desocupados/"
# Librerías
...
# Loading data ------------------------------------------------------------
encuesta_mrp <- readRDS("MrPDepartamental/CRI/2020/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
poststrat_df <- readRDS("MrPDepartamental/CRI/2020/Data/poststrat_df.RDS")
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/CRI/2020/Output/plot_",
