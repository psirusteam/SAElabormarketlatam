...
####################################################
encuesta <- readRDS("MrPDepartamental/ECU/2020/1.Ingreso/Data/encuestaECU20N.rds")
censo_mrp <- readRDS( "MrPDepartamental/ECU/2020/1.Ingreso/Data/censo_mrp.rds")

##############################
### Exploratory statistics ###
##############################
encuesta %>% mutate(depto = substr(upm, start = 1, stop = 2)) %>% 
...
# table(encuesta$upm, useNA = "always")
...
encuesta_mrp <- encuesta %>%
  ...
  transmute(
    depto = substr(upm, start = 1, stop = 2),
    depto = str_pad(
      string = depto,
      width = 2,
      pad = "0"
...
saveRDS(encuesta_mrp, file = "MrPDepartamental/ECU/2020/1.Ingreso/Data/encuesta_mrp.rds")
...
jpeg(filename = "MrPDepartamental/ECU/2020/1.Ingreso/Output/plot_actualizacion_censo1.jpeg",
...
jpeg(filename = "MrPDepartamental/ECU/2020/1.Ingreso/Output/plot_actualizacion_censo2.jpeg",
     width = 2000, height = 2000)
par(mfrow = c(2,2))
hist(censo_mrp$n)
boxplot(censo_mrp$n)
