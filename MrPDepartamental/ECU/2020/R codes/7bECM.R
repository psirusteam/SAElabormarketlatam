...
encuesta_mrp <- readRDS("ECU/2020/1.Ingreso/Data/encuesta_mrp.rds")
poststrat_df <- readRDS("ECU/2020/1.Ingreso/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
tasa_desocupados <- readRDS("ECU/2020/1.Ingreso/Data/tasa_desocupacion.rds")
fit <- readRDS("ECU/2020/1.Ingreso/Data/fit_bayes.rds")
...
openxlsx::write.xlsx(tablas, file = "ECU/2020/1.Ingreso/Output/tablas_ECM.xlsx", 
                     overwrite = TRUE)
