...
encuesta_mrp <- readRDS("PER/2020/1.Ingreso/Data/encuesta_mrp.rds")
tasa_desocupados <- readRDS("PER/2020/1.Ingreso/Data/tasa_desocupacion.rds")
...
saveRDS(fit, file = "PER/2020/1.Ingreso/Data/fit_bayes.rds")
# Assessment of the model -------------------------------------------------
#shinystan::launch_shinystan(fit)
############################################################
## Comparando los medelos Freq y Bayes
############################################################
# fit_freq <- readRDS("PER/2020/1.Ingreso/Data/fit_mrp_logshift.rds")[[1]]
# fit_Bayes <- readRDS("PER/2020/1.Ingreso/Data/fit_bayes.rds")
