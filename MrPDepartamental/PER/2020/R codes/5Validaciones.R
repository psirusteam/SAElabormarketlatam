...
if(!dir.exists("MrPDepartamental/PER/2020/Output/Tasa desocupados/")){
dir.create("MrPDepartamental/PER/2020/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/PER/2020/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/PER/2020/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/PER/2020/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/PER/2020/Output/Tasa participacion/")
}

outParticipacion <- "MrPDepartamental/PER/2020/Output/Tasa participacion/"
outOcupado <- "MrPDepartamental/PER/2020/Output/Tasa Ocupados/"
outDesocupado <- "MrPDepartamental/PER/2020/Output/Tasa desocupados/"
# Librerías
...
encuesta_mrp <- readRDS("MrPDepartamental/PER/2020/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
poststrat_df <- readRDS("MrPDepartamental/PER/2020/Data/poststrat_df.RDS")
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/PER/2020/Output/plot_",
