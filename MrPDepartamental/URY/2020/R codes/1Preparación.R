...
####################################################
encuesta <- readRDS("MrPDepartamental/URY/2020/1.Ingreso/Data/encuestaURY20N.rds")
censo_mrp <- readRDS( "MrPDepartamental/URY/2020/1.Ingreso/Data/censo_mrp.rds")
...
encuesta %>% group_by(dpto, condact3) %>%
...
saveRDS(encuesta_mrp, file = "MrPDepartamental/URY/2020/1.Ingreso/Data/encuesta_mrp.rds")
...
jpeg(filename = "MrPDepartamental/URY/2020/1.Ingreso/Output/plot_actualizacion_censo1.jpeg",
...
jpeg(filename = "MrPDepartamental/URY/2020/1.Ingreso/Output/plot_actualizacion_censo2.jpeg",
     width = 2000, height = 2000)
par(mfrow = c(2,2))
hist(censo_mrp$n)
boxplot(censo_mrp$n)
