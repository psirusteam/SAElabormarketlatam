...
if(!dir.exists("MrPDepartamental/URY/2020/Output/Tasa desocupados/")){
dir.create("MrPDepartamental/URY/2020/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/URY/2020/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/URY/2020/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/URY/2020/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/URY/2020/Output/Tasa participacion/")
}
...
# Loading data ------------------------------------------------------------
encuesta_mrp <- readRDS("MrPDepartamental/URY/2020/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/URY/2020/Output/plot_",
