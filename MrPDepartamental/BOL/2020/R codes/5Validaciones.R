...
if(!dir.exists("MrPDepartamental/BOL/2020/Output/Tasa desocupados/")){
  dir.create("MrPDepartamental/BOL/2020/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/BOL/2020/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/BOL/2020/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/BOL/2020/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/BOL/2020/Output/Tasa participacion/")
}
...
ggsave(plot = plot_uni, 
       filename = paste0(outOcupado,"plot_uni.jpeg"),scale = 5)
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/BOL/2020/Output/plot_",
