...
encuesta_mrp <- readRDS("BOL/2020/1.Ingreso/Data/encuesta_mrp.rds")
poststrat_df <- readRDS("BOL/2020/1.Ingreso/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
tasa_desocupados <- readRDS("BOL/2020/1.Ingreso/Data/tasa_desocupacion.rds")
fit <- readRDS("BOL/2020/1.Ingreso/Data/fit_bayes.rds")
...
openxlsx::write.xlsx(tablas, file = "BOL/2020/1.Ingreso/Output/tablas_ECM.xlsx", 
                     overwrite = TRUE)
