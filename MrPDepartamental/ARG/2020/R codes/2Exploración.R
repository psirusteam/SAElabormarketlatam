...
source(file = "MrPDepartamental/0Funciones/funciones_mrp.R", encoding = "UTF-8")
# Loading data ------------------------------------------------------------

encuesta_mrp <- readRDS("MrPDepartamental/ARG/2020/1.Desocupacion/Data/encuesta_mrp.rds")
censo_mrp <- readRDS("MrPDepartamental/ARG/2020/1.Desocupacion/Data/censo_mrp.rds")
