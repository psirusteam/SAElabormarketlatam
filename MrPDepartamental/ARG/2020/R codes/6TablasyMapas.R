...
## leer shape del pais
ShapeSAE <- read_sf("MrPDepartamental/ARG/2020/ShapeDeptoARG/provincia.shp") %>% filter(in1 != "94")
ShapeSAE %<>% mutate(depto = str_pad(in1, pad = "0", width = 2),
                     nombre = nam)
...
openxlsx::write.xlsx(dat_df, 
                     file = "MrPDepartamental/ARG/2020/Output/tablas.xlsx", 
                     overwrite = TRUE)
openxlsx::openXL("MrPDepartamental/ARG/2020/Output/tablas.xlsx")
