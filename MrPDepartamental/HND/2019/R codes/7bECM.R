...
encuesta_mrp <- readRDS("HND/2019/1.Ingreso/Data/encuesta_mrp.rds")
poststrat_df <- readRDS("HND/2019/1.Ingreso/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
tasa_desocupados <- readRDS("HND/2019/1.Ingreso/Data/tasa_desocupacion.rds")
fit <- readRDS("HND/2019/1.Ingreso/Data/fit_bayes.rds")
...
openxlsx::write.xlsx(tablas, file = "HND/2019/1.Ingreso/Output/tablas_ECM.xlsx", 
                     overwrite = TRUE)
