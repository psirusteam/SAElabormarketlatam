...
if(!dir.exists("MrPDepartamental/HND/2019/Output/Tasa desocupados/")){
dir.create("MrPDepartamental/HND/2019/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/HND/2019/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/HND/2019/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/HND/2019/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/HND/2019/Output/Tasa participacion/")
}
...
# Loading data ------------------------------------------------------------
encuesta_mrp <- readRDS("MrPDepartamental/HND/2019/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/HND/2019/Output/plot_",
