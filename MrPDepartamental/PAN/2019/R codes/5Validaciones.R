...
if(!dir.exists("MrPDepartamental/PAN/2019/Output/Tasa desocupados/")){
  dir.create("MrPDepartamental/PAN/2019/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/PAN/2019/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/PAN/2019/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/PAN/2019/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/PAN/2019/Output/Tasa participacion/")
}

outParticipacion <- "MrPDepartamental/PAN/2019/Output/Tasa participacion/"
outOcupado <- "MrPDepartamental/PAN/2019/Output/Tasa Ocupados/"
outDesocupado <- "MrPDepartamental/PAN/2019/Output/Tasa desocupados/"
# Librerías
...
# Loading data ------------------------------------------------------------
encuesta_mrp <- readRDS("MrPDepartamental/PAN/2019/Data/encuesta_mrp.rds") %>% 
  filter(edad != "1")
poststrat_df <- readRDS("MrPDepartamental/PAN/2019/Data/poststrat_df.RDS")
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/PAN/2019/Output/plot_",
