...
####################################################
encuesta <- readRDS("MrPDepartamental/PAN/2019/Data/encuestaPAN19N.rds")
censo_mrp <- readRDS( "MrPDepartamental/PAN/2019/Data/censo_mrp.rds")
...
# table(encuesta$prov, useNA = "always")
# labelled::generate_dictionary(encuesta %>% select(prov))
...
saveRDS(encuesta_mrp, file = "MrPDepartamental/PAN/2019/Data/encuesta_mrp.rds")
...
jpeg(filename = "MrPDepartamental/PAN/2019/Output/plot_actualizacion_censo1.jpeg",
...
jpeg(filename = "MrPDepartamental/PAN/2019/Output/plot_actualizacion_censo2.jpeg",
     width = 2000, height = 2000)
par(mfrow = c(2,2))
hist(censo_mrp$n)
boxplot(censo_mrp$n)
