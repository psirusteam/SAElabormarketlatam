...
## Leer Shape del pais
ShapeSAE <- read_sf("MrPDepartamental/PAN/2019/ShapeDeptoPAM/PAN_adm1.shp")
...
openxlsx::write.xlsx(dat_df, 
                     file = "MrPDepartamental/PAN/2019/Output/tablas.xlsx", 
                     overwrite = TRUE)
openxlsx::openXL("MrPDepartamental/PAN/2019/Output/tablas.xlsx")
