...
if(!dir.exists("MrPDepartamental/PRY2/2020/Output/Tasa desocupados/")){
dir.create("MrPDepartamental/PRY2/2020/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/PRY2/2020/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/PRY2/2020/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/PRY2/2020/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/PRY2/2020/Output/Tasa participacion/")
}
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/PRY2/2020/Output/plot_",
