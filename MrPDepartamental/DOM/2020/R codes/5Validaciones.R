...
if(!dir.exists("MrPDepartamental/DOM/2020/Output/Tasa desocupados/")){
  dir.create("MrPDepartamental/DOM/2020/Output/Tasa desocupados/")
}
if(!dir.exists("MrPDepartamental/DOM/2020/Output/Tasa Ocupados/")){
  dir.create("MrPDepartamental/DOM/2020/Output/Tasa Ocupados/")
}
if(!dir.exists("MrPDepartamental/DOM/2020/Output/Tasa participacion/")){
  dir.create("MrPDepartamental/DOM/2020/Output/Tasa participacion/")
}
...
#     ggsave(
#       paste0(
#         "MrPDepartamental/DOM/2020/Output/plot_",
