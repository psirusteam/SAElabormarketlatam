...
encuesta_mrp <- readRDS("DOM/2020/1.Ingreso/Data/encuesta_mrp.rds")
tasa_desocupados <- readRDS("DOM/2020/1.Ingreso/Data/tasa_desocupacion.rds")
...
byAgrega <-
  grep(
    pattern =  "^(n|trimestre|pobreza|ingreso|lp|li|fep)",
...
saveRDS(fit, file = "DOM/2020/1.Ingreso/Data/fit_bayes.rds")
# Assessment of the model -------------------------------------------------
#shinystan::launch_shinystan(fit)
############################################################
## Comparando los medelos Freq y Bayes
# ############################################################
# fit_freq <- readRDS("DOM/2020/1.Ingreso/Data/fit_mrp_logshift.rds")[[1]]
# fit_Bayes <- readRDS("DOM/2020/1.Ingreso/Data/fit_bayes.rds")
