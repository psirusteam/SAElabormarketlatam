...
encuesta_mrp <- readRDS("BRA/2020/1.Ingreso/Data/encuesta_mrp.rds")
poststrat_df <- readRDS("BRA/2020/1.Ingreso/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
tasa_desocupados <- readRDS("BRA/2020/1.Ingreso/Data/tasa_desocupacion.rds")
fit <- readRDS("BRA/2020/1.Ingreso/Data/fit_bayes.rds")
...
openxlsx::write.xlsx(tablas, file = "BRA/2020/1.Ingreso/Output/tablas_ECM.xlsx", 
                     overwrite = TRUE)
